    ...
    <>
      <div className="about">
        <div className="about__goon">
          <img className="goon" src={Goon} alt="Liz Tremblay Headshot" />
        </div>
        <div>
      ...
      <div className="about__coolThings about__section">
        ...
        <span>
          ...
          <div className="about__gallery">
            <div className="about__galleryIndividual">
              <a
                href="https://youtu.be/vKNPJY2J230?si=8rhLAWu4-NYQ6M9k"
                target="_blank"
                rel="noreferrer"
                aria-label="Chuckle Sandwich Episode 51 on  YouTube"
              >
                <img
                  className="about__gallery-img"
                  src={ChuckleSandwich}
            ...
            <div className="about__galleryIndividual">
              ...
              />
              <p>
                My most recent obsession has been Poppi. Not only does it taste
            ...
            <div className="about__galleryIndividual">
              <a
                href="https://www.uc.edu/news/articles/2023/02/beyond-the-classroom--qa-with-ibm-ux-design-co-op-liz-tremblay.html"
                target="_blank"
                rel="noreferrer"
                aria-label="Article by UC about my IBM co-op experience"
              >
                <img
                  className="about__gallery-img"
                  src={GoonUCArticle}
